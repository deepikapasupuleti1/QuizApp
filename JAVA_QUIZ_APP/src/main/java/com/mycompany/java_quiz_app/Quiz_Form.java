...
public class Quiz_Form extends javax.swing.JFrame {
    ...
    String[] questions = {"2+2= ?","3 - 3 = ?","5 + 5 = ?","10 X 9 =  ?","100 - 50 = ?"};
    // the last item is the correct answer
    //we will check the selected answer from the user with the last item
    String[][] options={{"100","9","4","0","4"},{"15","7","0","11","0"},{"20","10","15","5","10"},{"80","70","90","100","90"},{"60","50","40","25","50"}};
    ...
    public Quiz_Form() {
        ...
        jButton_Next_QuestionActionPerformed(null);
    }
    ...
    private void initComponents() {
        ...
        jButton_Next_Question = new javax.swing.JButton();
        ...
        jPanel_Q_ContainerLayout.setVerticalGroup(
            ...
            .addGroup(jPanel_Q_ContainerLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(Lbl_Question, javax.swing.GroupLayout.DEFAULT_SIZE, 115, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jButton_Next_Question.setBackground(new java.awt.Color(0, 204, 153));
        jButton_Next_Question.setForeground(new java.awt.Color(255, 255, 255));
        jButton_Next_Question.setText("Next");
        jButton_Next_Question.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton_Next_QuestionActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(80, 80, 80)
                        .addComponent(jButton_Next_Question, javax.swing.GroupLayout.PREFERRED_SIZE, 235, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jButton_Next_Question, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(54, 54, 54))
        );
    ...
    private void jButton_Next_QuestionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Next_QuestionActionPerformed

        if(jButton_Next_Question.getText().equals("Restart the Quiz"))
        {
            jButton_Next_Question.setText("Next");
            jPanel_Q_Container.setBackground(new java.awt.Color(204, 204, 204));
            index = 0;
        ...
        if(index == questions.length)
        {
            ...
            jButton_Next_Question.setText("Restart The Quiz");
        }
        ...
        else
        {
            ...
            if(index == questions.length-1){
                jButton_Next_Question.setText("Finish and see the result");
            }

        }
        //clear the selection
        bg.clearSelection();
    }//GEN-LAST:event_jButton_Next_QuestionActionPerformed
    ...
    private javax.swing.JButton jButton_Next_Question;
